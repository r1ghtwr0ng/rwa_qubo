...
### DISCLAMER: The full-source branch contains extra code used in early development stages. It is no longer maintained and likely contains sloppy/unused code. It is not recommended do use it as-is. Pull requests with fixes are welcome.
